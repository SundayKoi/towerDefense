...
// ===== QUANTUM =====
{
  ...
  BRANCH_SPECS.push({
    ...
    cards: [
      ...
      { shortName: 'SUPERCHARGE', description: 'After a QUANTUM crit, next shot deals +50% damage. 5s cooldown between arms.',
  ...
  BRANCH_SPECS.push({
    ...
    cards: [
      ...
      { shortName: 'UNCERTAINTY', description: 'Entanglement arcs (if any) reduce target armor 25% for 2s.',
        ...
        extraRequires: ['quantum_col_4'] /* ENTANGLEMENT */ },
  ...
  BRANCH_SPECS.push({
    ...
    cards: [
      ...
      { shortName: 'APEX PREDATOR', description: 'ONE SHOT threshold raises to 50% HP.',
        ...
        extraRequires: ['sniper_exe_2'] /* ONE SHOT */ },
  ...
  BRANCH_SPECS.push({
    ...
    cards: [
      ...
      { shortName: 'NULL FIELD', description: 'BROADCAST pulse also slows all hit enemies 20% for 1.5s.',
        ...
        extraRequires: ['scrambler_dec_2'] /* BROADCAST */ },
...
const UNIVERSAL: CardDef[] = [
  {
    ...
    rarity: 'common',
    category: 'exotic',
    description: '+2% global damage. Repeatable.',
    repeatable: true,
    apply: (s) => { s.mods.globalDamagePct += 0.02; },
  },
  {
    id: 'uni_calibration',
    name: 'CALIBRATION',
    rarity: 'common',
    category: 'exotic',
    description: '+2% global fire rate. Repeatable.',
    repeatable: true,
    apply: (s) => { s.mods.globalRatePct += 0.02; },
  },
  {
    id: 'uni_sensor_tune',
    name: 'SENSOR TUNE',
